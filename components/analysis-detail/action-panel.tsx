...
export function ActionPanel({ onToggleHistory }: ActionPanelProps) {
  ...
  const handleShowDataLayers = () => {
    toast.info("Camadas de dados não estão disponíveis no momento. Esta funcionalidade será implementada em breve.");
  };
